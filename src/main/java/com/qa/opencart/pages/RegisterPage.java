...
public class RegisterPage {
	...
	//Creating Constructor
		...
		public boolean registerUser(String firstName , String lastName, String email,
			...
			eleUtil.WaitForElementVisible(AppConstants.DEFAULT_SHORT_TIME_OUT, this.firstname).sendKeys(firstName);
			...
			String successMesg = eleUtil.WaitForElementVisible(AppConstants.DEFAULT_MEDIUM_TIME_OUT,registerSuccessMesg).getText();
			
			System.out.println("user reg success messg :"+successMesg);
			
			if(successMesg.contains(AppConstants.USER_REG_SUCCESS_MESSG)) {
				//For other user's to eneter registration details 
